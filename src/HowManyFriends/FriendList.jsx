...
const FriendList = () => {
    return (
        <div className=' bg-[#F8FAFC] mt-20'>
              <div className='container mx-auto bg bg-[#F8FAFC] space-y-10 pt-15'>
...
relationships that matter most.</h3> 
                 ...
                 <div className='grid md:grid-cols-2 lg:grid-cols-4 justify-center items-center gap-6  pb-10 pl-40 pr-40'>
